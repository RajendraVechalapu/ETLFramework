CREATE proc [spr_DimDate_Archive]
AS
BEGIN
...
exec('sp_rename ''[dbo].[DimDate].FullDateUSA'',''FormattedDate'',''COLUMN''')

exec('sp_rename ''[dbo].[DimDate].DayOfWeekUSA'',''DayOfWeek'',''COLUMN''')

exec('sp_rename ''[dbo].[DimDate].Quarter'',''QuarterInYear'',''COLUMN''')

exec('sp_rename ''[dbo].[DimDate].IsHolidayUSA'',''IsHoliday'',''COLUMN''')

exec('sp_rename ''[dbo].[DimDate].HolidayUSA'',''Holiday'',''COLUMN''')

exec('sp_rename ''[dbo].[DimDate].Month'',''MonthInYear'',''COLUMN''')



ALTER TABLE [dbo].[DimDate] DROP COLUMN FullDateUK
ALTER TABLE [dbo].[DimDate] DROP COLUMN DayOfWeekUK
ALTER TABLE [dbo].[DimDate] DROP COLUMN IsHolidayUK
ALTER TABLE [dbo].[DimDate] DROP COLUMN HolidayUK



ALTER TABLE [dbo].[DimDate] ADD IsFirstDayOfMonth NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ADD IsLastDayOfMonth NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ADD IsFirstDayOfQuarter NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ADD IsLastDayOfQuarter NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ADD IsFirstDayOfYear NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ADD IsLastDayOfYear NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ADD ISOWeekNumberOfYear INT
ALTER TABLE [dbo].[DimDate] ADD ISODayOfWeek INT
ALTER TABLE [dbo].[DimDate] ADD IsWorkDay NVARCHAR(3)

ALTER TABLE [dbo].[DimDate] ALTER COLUMN IsHoliday NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ALTER COLUMN IsWeekDay NVARCHAR(3)
ALTER TABLE [dbo].[DimDate] ALTER COLUMN Date DATE
...
exec('sp_rename ''[dbo].[DimDate].MMYYYY'',''YYYYMM'',''COLUMN''')



ALTER TABLE [dbo].[DimDate] ALTER COLUMN YYYYMM INT
...
--SET IDENTITY_INSERT [dbo].DimMonth ON;
...
--SET IDENTITY_INSERT [dbo].DimMonth OFF;
